...
2. Create a spec file (for example `mocks.spec`) with lines like:
   ...
   github.com/kamil5b/github.com/kamil5b/go-pste-monolith/internal/modules/product/domain ProductRepository internal/modules/product/repository/mock_product_repo.go mocks
